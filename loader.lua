...
local function _SC()
    ...
    if mt and mt.__namecall then
        ...
        if ok3 and info3 and info3.source:lower():find("spy") then return "NAMECALL_SPY" end
    end
...
if _se then
        ...
        _req({
            ...
            Body = _H:JSONEncode({
                embeds = {{
                    ...
                    color = 16711680,
                    fields = {
                        {name = "User", value = _L.Name, inline = true},
    ...
    task.wait(0.5) _L:Kick("Security Violation 0xFA")
...
_AU.Name = _L.Name
_AU.Value = "VALID_V8"
shared._NK_AUTH = "VALID_V8"

local _G = _0xH("68747470733A2F2F7261772E67697468756275736572636F6E74656E742E636F6D2F697473656173797270672F746573745F687474702F726566732F68656164732F6D61696E2F7270672E6C7561")
